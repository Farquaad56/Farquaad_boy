...
/// Bit 4 du LCDC : ensemble of tuiles du fond en $8800-$97FF (indices signés) au lieu of $8000-$8FFF.
...
/// Base dans la VRAM of the ensemble of tuiles en $8800 (bit 4 du LCDC, indices signés) — index relatif à $8000.

...
pub const DMG_BOOT_ROM: [u8; BOOT_ROM_SIZE] = [
    ...
    0x1e, 0x02, 0x0e, 0x1d, 0xf0, 0x44, 0xfe, 0x90, 0x20, 0xfa, 0x0d, 0x20, 0xf7, 0x0c, 0x20, 0xf2,
...
mod tests {
    ...
    fn embedded_dmg_boot_rom_has_canonical_edges() {
        ...
        // le checksum de l'en-tête est `ADD A,H` (0x86) aux deux endroits.
        assert_eq!(DMG_BOOT_ROM[0xF4], 0x86);
        assert_eq!(DMG_BOOT_ROM[0xF9], 0x86);
    }
}
